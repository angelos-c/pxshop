// Black Mamba has no manufacturer XLSX catalogue — name & fitment are parsed
...
export const BLACK_MAMBA_NAME_OVERRIDES = {};

/** @type {Record<string, string[]>} SKU -> exact fitment tag list override. */
export const BLACK_MAMBA_FITMENT_OVERRIDES = {};
